...
* lib.o - Библиотека из предыдущей лабораторной работы
* lib.inc - Перечисление extern функций из библиотеки lib.o, которые используются в данной лабораторной работе
* colon.inc - Макрос для генерации словаря
* words.inc - Генерация словаря с данными
* dict.asm - Операции поиска и получения значения из словаря
* main.asm - Основная программа

# Примечания к лабораторной работе

* Библиотека из первой лабораторной работы предварительно скомпилирована в lib.o и добавлена в проект
* Так как в предыдущей лабораторной работе не было функции вывода строки в stderr, данная функция реализована в файле main.asm
* В файле dict.asm реализована функция get_value для получения значения элемента словаря
...
|:--:|
| <b>Рисунок 1. Результаты работы программы </b> |
